...
# import pb.router_pb2 as router__pb2
...
class RouterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetResult = channel.unary_unary(
                '/router.Router/GetResult',
                request_serializer=router__pb2.RouterRequest.SerializeToString,
                response_deserializer=router__pb2.RouterResponse.FromString,
...
def add_RouterServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetResult': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=router__pb2.RouterResponse.SerializeToString,
            ),
    }
...
class Router(object):
    ...
    def GetResult(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            router__pb2.RouterResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
